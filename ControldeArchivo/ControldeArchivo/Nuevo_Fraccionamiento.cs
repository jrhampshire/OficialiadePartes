...
{
    public partial class Nuevo_Fraccionamiento : Form
    {
        public Nuevo_Fraccionamiento()
        {
            InitializeComponent();
        }
                ...
                if(Guardar==true)
                {
                    try
                    {
                        ...
                        using (SqlCommand Cmd = new SqlCommand())
                        {
                            ...
                            Cmd.CommandType = CommandType.Text;
                            Cmd.CommandText = "Insert into Fraccionamientos (Id_Localidad, Nombre) Values(@Id_Loc,@Nombre)";
        ...
        private void Nuevo_Fraccionamiento_Load(object sender, EventArgs e)
        {
            CargaDatos();
        }
    }
